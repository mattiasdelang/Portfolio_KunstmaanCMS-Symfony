 ...
 * ButtonPagePart
 *
 * @ORM\Table(name="portfolio_button_page_parts")
 * @ORM\Entity
 */
class ButtonPagePart extends AbstractPagePart
{
    ...
    {
	return 'kumaPortfolioBundle:PageParts:ButtonPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \kuma\PortfolioBundle\Form\PageParts\ButtonPagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \kuma\PortfolioBundle\Form\PageParts\ButtonPagePartAdminType();
    }
