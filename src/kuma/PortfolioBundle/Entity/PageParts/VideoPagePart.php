...
/**
 * @ORM\Entity
 * @ORM\Table(name="portfolio_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
	return "kumaPortfolioBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
	return new \kuma\PortfolioBundle\Form\PageParts\VideoPagePartAdminType();
    }
}
