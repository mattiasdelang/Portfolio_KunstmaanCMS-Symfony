 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="portfolio_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
	return 'kumaPortfolioBundle:PageParts:ImagePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \kuma\PortfolioBundle\Form\PageParts\ImagePagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \kuma\PortfolioBundle\Form\PageParts\ImagePagePartAdminType();
    }
}
