...
namespace kuma\PortfolioBundle\DataFixtures\ORM\DefaultSiteGenerator;
...
use kuma\PortfolioBundle\Entity\Pages\ContentPage;
use kuma\PortfolioBundle\Entity\Pages\HomePage;
